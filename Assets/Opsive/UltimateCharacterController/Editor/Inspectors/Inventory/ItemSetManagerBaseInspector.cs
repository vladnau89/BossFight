...
namespace Opsive.UltimateCharacterController.Editor.Inspectors.Inventory
{
    ...
    public abstract class ItemSetManagerBaseInspector : InspectorBase
    {
        ...
        private void OnItemSetElementDraw(Rect rect, int index, bool isActive, bool isFocused)
        {
            ...
            GUI.Label(rowRect, "", Shared.Editor.Inspectors.Utility.InspectorStyles.FieldStyle);
            ...
            GUI.Label(elementTitleRect, "Item Set " + index + (itemSetActive ? " (Active)" : ""), Shared.Editor.Inspectors.Utility.InspectorStyles.CenterBoldLabel);
            ...
            for (int i = 0; i < m_InventoryBase.SlotCount; ++i) {
                ...
                GUI.Label(slotRect, "", Shared.Editor.Inspectors.Utility.InspectorStyles.ItemStyle);
                GUI.color = color;
